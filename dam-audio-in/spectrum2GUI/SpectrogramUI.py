...
class SpectrogramCanvas(FigureCanvas):
	...
	def updateParameters(self, fftSize, sampleRate, audioChannels):
...
class MainWindow(QtGui.QMainWindow):
	...
	def _setupControls(self):
		...
		parameters.layout().addWidget(QtGui.QLabel('Audio Channels:'), 2, 0)
		parameters.layout().addWidget(audioChannels, 2, 1)
		parameters.layout().addWidget(modifyBtn, 3, 1)
	...
	def _updateDeviceUI(self):
		...
		self.audioChannels.setText('%d' % audioChannels)
		
		self.spectrogram.updateParameters(fftSize, sampleRate, audioChannels)
