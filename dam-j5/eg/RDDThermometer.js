...
// Thermometer Component and an MCP9808 temperature sensor.
//
...
/**
 * This RDD_MCP9808 Controller object talks to a Remote Device Driver on an
 * Arduino that is connected to an MCP9808 Temperature Sensor.
 * @param freq Update period (not frequency) in milliseconds.  default : 25
 * @param unit Logical unit name and number.  default "MCP9808:0"
 */
let controller = { RDD_MCP9808: {
  initialize : {
